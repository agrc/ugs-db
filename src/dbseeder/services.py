...
class Normalizer(object):
    ...
    def normalize_sample(cls, row):
        ...
        def calculate_paramgroup(chemical):
            if chemical in cls.paramgroup:
                paramgroup = cls.paramgroup[chemical]
                return paramgroup
